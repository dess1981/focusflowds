...
import { Plus, Clock, ChevronLeft, ChevronRight, Trash2, RefreshCw } from 'lucide-react';
        ...
        <DialogContent className="max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!form.title.trim() || !form.start_time || !form.end_time || saveMutation.isPending}
            >
              {saveMutation.isPending ? 'Salvando...' : editBlock ? 'Salvar' : form.recurrence !== 'none' ? 'Criar Série' : 'Criar Bloco'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
