  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/10 border border-primary/30 hover:bg-primary/20 transition-colors text-sm text-muted-foreground md:bottom-auto md:top-4 md:right-4"
      >
